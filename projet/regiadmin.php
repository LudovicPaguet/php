...
session_start();
    ...
    $statement = $base->query("INSERT INTO Login(userID,Password,Administrator) VALUES ('$id','$password','$administrator')");
     $statement2 = $base->query("INSERT INTO secretary(Name,Surname,userID) VALUES ('$name','$Surname','$id')");
...
<body>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <center> <h2>Register Page for admin</h2>   
  ...
  <form role="form" method="post" action="Regiadmin.php" >
