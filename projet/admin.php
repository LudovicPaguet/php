...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <?php  
            include "config.php";
            $reponse =  $bdd->query('SELECT last_time FROM login where userID="'. $_SESSION['number'].'"');
              while ($donnee = $reponse->fetch())
                {  
        $date=$donnee['last_time'];
                }
...
float: right;
font-size: 16px;"> Last access : <?php echo $day; echo ' ' ;echo $months; echo ' ' ; echo $year; ?>&nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="adminsick.php"><i class="fa fa-desktop fa-3x"></i> Sick letter</a>
                    </li>
        ...
        <div id="page-wrapper" >
            ...
            $reponse2 =  $bdd->query('SELECT Name,Surname FROM secretary where userID="'. $_SESSION['number'].'"');
        ...
        $surname=$donnees['Surname'];
                ...
                ?>
                        <h5>Welcome <?php echo $name; echo ' '; echo $surname;  ?> , Love to see you back. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
