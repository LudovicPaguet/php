...
session_start();
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = 'SELECT count(*) FROM login WHERE userID="'.$_POST['number'].'" AND Password="'.$_POST['pass'].'" AND Administrator="0"';
        $req = $base->query($sql);
...
<body>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <center> <h2>Login Page for student</h2>   
  ...
  <form role="form" method="post" action="logstudent.php" >
              <div class="form-group">
              <div class="col-md-6">
                   <center> <label>Student Number</label></center><br>
